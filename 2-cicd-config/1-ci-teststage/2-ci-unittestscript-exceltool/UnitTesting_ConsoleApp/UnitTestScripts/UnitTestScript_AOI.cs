...
namespace UnitTesting_ConsoleApp.UnitTestScripts
{
    ...
    internal class UnitTestScript_AOI
    {
        ...
        ///    -  The Studio 5000 component is being unit tested (options: AOI_Definition.L5X, Rung.L5X, Routine.L5X, Program.L5X, Application.ACD).<br/>
        ...
        public static async Task RunTest(string[] args)
        {
            ...
            string inputExcelFilePath = githubPath + @"2-cicd-config\1-ci-teststage\3-ci-inputexcelworkbooks-forunittestscripts\" + inputExcelFileName;

            // This folder will contain the generated ACD files and/or L5X files required for AOI unit testing.
            string generatedFilesFolderPath = githubPath + @"2-cicd-config\1-ci-teststage\x-generatedfiles\";
            ...
            string outputExcelFilePath = githubPath + @"3-test-reports\excelreports\" + currentDateTime + "_" + testObjectName + "_UnitTestReport.xlsx";
            string outputTextFileName = currentDateTime + "_" + testObjectName + "_UnitTestReport";
            string outputTextFilePath = githubPath + @"3-test-reports\textreports\" + outputTextFileName + ".txt";
            ...
            ChangeControllerMode_Async(commPath, "TEST", logixProject).GetAwaiter().GetResult();
            ...
            for (int i = 0; i < testCases; i++)
            {
                ...
                for (int j = 1; j < numberOfClockCycles + 1; j++)
                {
                    ...
                    if (faultedState)
                    {
                        ConsoleMessage($"Controller faulted with type #{AT_FaultType.OnlineVal} & code #{AT_FaultCode.OnlineVal}.", "ERROR");
            ...
            string textReportsFolderPath = githubPath + @"3-test-reports\textreports";
            ...
            string excelReportsFolderPath = githubPath + @"3-test-reports\excelreports";
            ...
            string temporaryFilesFolderPath = githubPath + @"2-cicd-config\1-ci-teststage\x-generatedfiles";
            ...
            string textFileReportPath = githubPath + @"3-test-reports\textreports\" + currentDateTime + "_unittestfile.txt";   // The text report file path (renamed here).
...
This a programmatically created rung with a populated instance of the AOI instruction added using the Logix Designer SDK.";
        ...
        public static Dictionary<string, string> GetExcelTestCaseValues(string excelFilePath, int columnNumber)
        {
            ...
            {
                ExcelWorksheet worksheet = package.Workbook.Worksheets[0];
                int numberOfParameters = GetPopulatedCellsInColumnCount(excelFilePath, 2) - 7;
